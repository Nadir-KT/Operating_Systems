...
FILE    : $Id: r_bsp_api.h 15516 2018-01-26 09:21:43Z matthias.nippert $
============================================================================ 
DESCRIPTION
...
/* Device has either a SDR-SDRAM (SDRA) interface or DDR-SDRAM (SDRB) interface*/
#define R_BSP_HAS_SDRAM             0x1u
/* Device has a serial memory interface (SFMA / HYPB / OCTA) */
#define R_BSP_HAS_SERIAL_FLASH      0x2u
/* Device has VDCE0 Video Output channel */
#define R_BSP_HAS_VOUT0             0x4u
/* Device has VDCE1 Video Output channel */
#define R_BSP_HAS_VOUT1             0x8u  
/* Device has SFMA memory interface with high-speed DDR mode support */
#define R_BSP_HAS_DDR_SF            0x10u
/* Device has SFMA memory interface with 8-bit mode support */
#define R_BSP_HAS_8BIT_SF           0x20u
/* Device has extended SPEA implementation with 4 RLE/Sprite layers */
#define R_BSP_HAS_SPEA_V2           0x40u
/* Device has Preload Buffer */
#define R_BSP_HAS_PRLB              0x80u
