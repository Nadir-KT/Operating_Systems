...
FILE    : $Id: saa71xx_main.c 16815 2019-07-03 09:41:18Z matthias.nippert@renesas.com $
============================================================================
DESCRIPTION
...
*/
#ifndef USE_VIN_NTSC
    /* May also be used by other modules. Do not change this value, but define it by compiler flags. */
    #define USE_VIN_NTSC      (0u)
#endif
