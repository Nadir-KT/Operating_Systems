...
FILE    : $Id: sys_saa71xx.c 16855 2019-08-06 01:12:45Z shinya.tomari.wj@renesas.com $
============================================================================
DESCRIPTION
...
#ifdef USE_RIIC /* ignore, when RIIC driver not available */
...
/* USE_VIN_SVIDEO
    ...
    1 = S-Video input 
*/
#ifndef USE_VIN_SVIDEO
    #define USE_VIN_SVIDEO      (0u)
#endif
...
R_SAA71xx_Error_t R_SAA71xx_Sys_PortInit(uint32_t Unit)
{
    ...
    if ( (dev == R_DEV_R7F701411) || (dev == R_DEV_R7F701412)) {
        R_BSP_STDIO_Printf(" D1M2H Mango Adapter Board: Switch on DSW2-2 and DSW2-3.\n");
    }else if ( (dev == R_DEV_R7F701406) || (dev == R_DEV_R7F701407)) {
        R_BSP_STDIO_Printf(" D1M1H Mango Adapter Board: Switch off DSW2-3.\n");
    }else if ( (dev == R_DEV_R7F701441)) {
        R_BSP_STDIO_Printf(" D1M1A Mango Adapter Board: Switch off DSW1-1 and DSW1-7, switch on DSW1-2 and DSW1-6.\n");
    }else if ( (dev == R_DEV_R7F701442)) {
        R_BSP_STDIO_Printf(" D1L2H Mango Adapter Board:   Switch off DSW2-3.\n");
        R_BSP_STDIO_Printf(" D1M1-V2 Mango Adapter Board: Switch off DSW2-1 and DSW2-4.\n");
    } else {
        R_BSP_STDIO_Printf(" Mango Adapter (XXXXX): Please add documentation for the current adapter board.\n");
    }
...
{
#ifdef USE_RIIC /* do nothing, when RIIC driver not available */
    /* disable RIIC */
