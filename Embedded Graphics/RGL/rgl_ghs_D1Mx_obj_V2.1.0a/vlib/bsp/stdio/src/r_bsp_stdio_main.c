...
FILE    : $Id: r_bsp_stdio_main.c 16747 2019-05-20 05:26:41Z shinya.tomari.wj@renesas.com $
============================================================================
DESCRIPTION
...
#ifdef R_BSP_STDOUT_FILE
/*******************************************************************************
  Variable: Fp

  File pointer
*/
static FILE   *Fp = R_NULL;
#endif
