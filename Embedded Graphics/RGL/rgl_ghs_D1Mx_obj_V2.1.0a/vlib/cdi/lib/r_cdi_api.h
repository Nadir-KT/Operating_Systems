...
/*******************************************************************************
  Macro: CDI_USE_DEPRECATED_API

  Set value to zero to block usage of the old API.
  It will be removed in the future.
  The new API is a full and more versatile replacement.

  Old API:
   * r_cdi_HpType_t
   * r_cdi_HeapMng_t
   * R_CDI_InitCpuHeapManager
   * R_CDI_InitVidHeapManager
   * R_CDI_InitSmHeapManager
   * R_CDI_HeapAlloc
   * R_CDI_HeapResetNextFreeBlockNb
   * R_CDI_HeapFree
   * R_CDI_HeapFreeAll
   * R_CDI_GetHeapSize
   * R_CDI_GetVidHeapBlockSize
   * R_CDI_GetVidHeapBlockMax
   * R_CDI_GetVidHeapBlockUsed
   * R_CDI_GetCpuHeapBlockSize
   * R_CDI_GetCpuHeapBlockMax
   * R_CDI_GetCpuHeapBlockUsed
  New API:
   * r_cdi_Heap_t
   * R_CDI_InitHeapManager
   * R_CDI_Alloc
   * R_CDI_AllocAlign
   * R_CDI_Free
   
*/                         
#define CDI_USE_DEPRECATED_API (1)
