...
/***************************************************************************
  ...
  Values:
  R_VDCE_CAPT_NO_DISPLAY - Capture without display.
*/
...
/***************************************************************************
  ...
  R_VDCE_ERR_PIXEL_CLOCK           - It failed in the pixel clock setting.
...
typedef enum
{
    R_VDCE_INTC_NONE                   = 0,
    /* R_VDCE_S0_LO_VSYNC */
    R_VDCE_INTC_VBLANK                 = 1,
    /* R_VDCE_S1_LO_VSYNC */
    R_VDCE_INTC_VBLANK_1               = 2,
    /* R_VDCE_GR3_VBLANK delayed for discom */
    R_VDCE_INTC_VBLANK_DELAY           = 3,
    /* R_VDCE_GR3_VLINE */
    R_VDCE_INTC_SCANLINE               = 4,
    /* R_VDCE_OIR_VLINE */
    R_VDCE_INTC_OIR_SCANLINE           = 5,
    /* R_VDCE_OIR_LO_VSYNC */
    R_VDCE_INTC_OIR_VBLANK             = 6,
    /* R_VDCE_OIR_VI_VSYNC */
    R_VDCE_INTC_OIR_VSCYNC_WRITE       = 7,
    /* R_VDCE_S0_LO_VSYNC */ 
    R_VDCE_INTC_ERROR                  = 8,
    /* R_VDCE_S0_VSYNCERR */
    R_VDCE_INTC_NO_VI_VSYNC_SIGNAL     = 9,
    /* R_VDCE_S1_VSYNCERR */
    R_VDCE_INTC_NO_VI_VSYNC_SIGNAL_1    = 10,
    /* R_VDCE_IV8_VBUFERR */
    R_VDCE_INTC_ERR_OIR_UNDERFLOW      = 11,
    /* R_VDCE_IV3_VBUFERR */
    R_VDCE_INTC_ERR_LAYER0_UNDERFLOW   = 12,
    /* R_VDCE_IV4_VBUFERR */
    R_VDCE_INTC_ERR_LAYER1_UNDERFLOW   = 13,
    /* R_VDCE_IV5_VBUFERR */
    R_VDCE_INTC_ERR_LAYER2_UNDERFLOW   = 14,
    /* R_VDCE_IV6_VBUFERR */
    R_VDCE_INTC_ERR_LAYER3_UNDERFLOW   = 15,
    /* R_VDCE_S0_VI_VSYNC */
    R_VDCE_INTC_CAP_VBLANK             = 16,
    /* R_VDCE_S0_VFIELD */
    R_VDCE_INTC_CAP_END_OF_FIELD       = 17,
    /* R_VDCE_IV1_VBUFERR */
    R_VDCE_INTC_ERR_CAP_WRITE_OVERFLOW = 18,
    /* End of table */
    R_VDCE_INTC_MAX                    = 19
} r_vdce_IntType_t;
...
/***************************************************************************
  ...
  Description:
  This type is used to select whether the output data' blue and red is swapped
  <R_VDCE_DisplayOutSwapBR>.
...
/***************************************************************************
  ...
  R_VDCE_TCON_POLMD_1X1REV - 1x1 reverse mode.
                             Generates the signal whose polarity is inverted every horizontal
                             period.
  R_VDCE_TCON_POLMD_1X2REV - 1x2 reverse mode
                             Generates the signal whose polarity is inverted in the first
                             horizontal period and is subsequently inverted every two horizontal
                             periods.
  R_VDCE_TCON_POLMD_2X2REV - 2x2 reverse mode
                             Generates the signal whose polarity is inverted every two
                             horizontal periods.
*/
typedef enum
{
...
/***************************************************************************
  ...
  Description:
  The type is used to specify scale-up/scale-down behaviour.
...
/***************************************************************************
  ...
  R_VDCE_SCALE_H_PREFILTER     - Enable a horizontal pre filter.
                                 Horizontal pre filter can be used when the horizontal scale is
                                 reduced. If this flag is on, the frequency band for Brightness
                                 (Y) and RGB signals are suppressed. If this flag is off,
                                 horizontal pre filter is disabled.
...
/***************************************************************************
  ...
  Values:
  R_VDCE_CAP_MODE_YUV_ITU656       - Select ITU-R BT.656 mode.
  ...
  R_VDCE_CAP_MODE_BIG_ENDIAN       - Captureing with big endian. If this flag is not set, little endian 
                                     is selected.
  R_VDCE_CAP_MODE_DE_MODE          - If this flag is off, DE mode is disabled. Hsync signal is 
                                     used to capture.
                                     ...
                                     R_VDCE_CAP_MODE_HSYNC_INVERT or 
                                     R_VDCE_CAP_MODE_HSYNC_CLK_INVERT flag is valid for DE signal.
                                     DE mode can be selected in case of YCbCr422/RGB565/RGB666/
                                     RGB888/YCbCr444 input mode.
  R_VDCE_CAP_MODE_PAL              - If this flag is off, input signal is assumed as 
                                     NTSC (525 Lines/59.94 Hz) system.
                                     If this flag is on, input signal is assumed as 
                                     PAL (625 Lines/50.00 Hz) system.
                                     This flag is valid in case of BT.656 or BT.601 input mode.
  R_VDCE_CAP_MODE_EAV              - If this flag is off, SAV code is converted to Hsync signal.
                                     If this flag is on, EAV code is converted to Hsync signal.
                                     This flag is valid in case of BT.656 input mode.
  R_VDCE_CAP_MODE_SYNC_ONLY        - If this flag is off, input data is written to capture buffer.
...
typedef enum
{
    ...
    R_VDCE_CAP_MODE_DE_MODE          = (int32_t)(1uL<< 22),
    R_VDCE_CAP_MODE_PAL              = (int32_t)(1uL<< 23),
    R_VDCE_CAP_MODE_EAV              = (int32_t)(1uL<< 24),
    R_VDCE_CAP_MODE_SYNC_ONLY        = (int32_t)(1uL<< 25)
} r_vdce_CapMode_t;
...
/***************************************************************************
  Enum: r_vdce_CapRate_t

  Description:
  This type is used to select the capture buffer writing rate 
  in the function <R_VDCE_CapRateSet>.

  Values:
  R_VDCE_CAP_RATE_PER1 - 1/1 an input signal.
  R_VDCE_CAP_RATE_PER2 - 1/2 an input signal.
  R_VDCE_CAP_RATE_PER4 - 1/4 an input signal.
  R_VDCE_CAP_RATE_PER8 - 1/8 an input signal.
*/
typedef enum
{
    R_VDCE_CAP_RATE_PER1 = 0,
    R_VDCE_CAP_RATE_PER2,
    R_VDCE_CAP_RATE_PER4,
    R_VDCE_CAP_RATE_PER8
} r_vdce_CapRate_t;

/***************************************************************************
  Enum: r_vdce_CapField_t

  Description:
  This type is used to select the capture buffer writing field select. 
  in the function <R_VDCE_CapRateSet>.
  When writing rate 1/2, 1/4, or 1/8 is selected, either the top or bottom field 
  can be selected for writing.
  When writing rate 1/1 is selected, Top/Bottom setting is ignored.

  Values:
  R_VDCE_CAP_FIELD_TOP    - Input is interlace and write both field (1/1) or 
                            write only top field (1/2, 1/4, 1/8).
  R_VDCE_CAP_FIELD_BOTTOM - Input is interlace and write both field (1/1) or 
                            write only bottom field (1/2, 1/4, 1/8).
  R_VDCE_CAP_FIELD_FRAME  - Input is progressive.
*/
typedef enum
{
    R_VDCE_CAP_FIELD_TOP = 0,
    R_VDCE_CAP_FIELD_BOTTOM,
    R_VDCE_CAP_FIELD_FRAME
} r_vdce_CapField_t;
...
/***************************************************************************
  ...
  Parameter:
  Unit    - It specifies the video output number.
  IntcType - The interrupt type specifies the Interrupt event, which can be selected.
...
/***************************************************************************
  ...
  Description:
  This function enables the activation of an interrupt of type IntcType.
  IntcType can be an order value of <r_vdce_IntType_t>.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  Description:
  This function disables the activation of an interrupt of type IntcType.
  IntcType can be an order value of <r_vdce_IntType_t>.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/****************************************************************************
  ...
  Parameter:
  Unit     - It specifies the video output number.
  Scanline - It specifies the interrupt occurrence timing by the location of image line at 
             OIR layer.
...
/***************************************************************************
  Function: R_VDCE_DisplayTimingGet
  
  Description:
  This function gets the display timing set by <R_VDCE_DisplayTimingSet>.
  Execute <R_VDCE_DisplayTimingSet> before executing this function.
  The display timing here is not affected by <R_VDCE_DisplayTimingAdjust>.
...
*/
r_vdce_Error_t R_VDCE_DisplayTimingGet(const uint32_t               Unit,
                                       r_ddb_Timing_t  *const       Timing);
...
/***************************************************************************
  ...
  Execute <R_VDCE_DisplayTimingSet> before executing this function.
  This setting is valid until <R_VDCE_DisplayTimingSet>, <R_VDCE_DisplayTimingAdjust>,
  or <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  About Following signals, 
  the polarity should be set by <R_VDCE_DisplayTimingSet> with Timing->Flags.  
  - R_VDCE_PIN_ENABLE
  - R_VDCE_PIN_VSYNC 
  - R_VDCE_PIN_HSYNC 
  Setting by this function is not effective.
...
/***************************************************************************
  ...
  Description:
  This function sets the Serial RGB output setting.
  This setting is valid when Serial RGB output is selected by <R_VDCE_DisplayOutFormatSet>.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  <R_VDCE_CapExtVsyncSet> provides the same feature, and is even more accurate.
  <R_VDCE_CapExtVsyncSet> setting takses precedence over this function.
...
/***************************************************************************
  ...
  This setting is valid until <R_VDCE_DeInit> is executed.
  This function has same feature as <R_VDCE_LayerBufSet> except Lock/Unlock call.
...
/***************************************************************************
  ...
  LayerNr   - It specifies the layer from the following.
                ...
                R_VDCE_LAYER_IMAGE2  / 
                R_VDCE_LAYER_IMAGE3  
  Stride    - This is the width of the virtual memory window in pixel. 
              Range is (1024 / bpp) to (261120 / bpp).
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after the layer status is changed from Idle
                      to Executing.)
*/
...
/***************************************************************************
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after OIR status is changed from Idle
                      to Executing.)
*/
...
/***************************************************************************
  ...
  Description:
  This function switches from a full framebuffer for the layer to a ring buffer usage.
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after the layer status is changed 
...
/***************************************************************************
  ...
  Description:
  This function switches from a full framebuffer for the output image renderer read layer
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after OIR status is changed from 
                      Idle to Executing.)
*/
...
/***************************************************************************
  ...
  Description:
  This function switches back from ring buffer a full framebuffer usage of the layer.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after the layer status is changed from
                      Idle to Executing.)
*/
...
/***************************************************************************
  ...
  Description:
  This function switches back from ring buffer a full framebuffer usage of the
...
/****************************************************************************
  ...
  LayerNr      - It specifies the layer from the following.
                   ...
                   R_VDCE_LAYER_IMAGE2  / 
                   R_VDCE_LAYER_IMAGE3  
  LayerMode    - The layer mode. The flags of type <r_vdce_LayerMode_t> can be combined with '|'.
                 See <r_vdce_LayerMode_t>.
...
/***************************************************************************
  ...
  Executing     - OK [The layer status will be changed to "Idle". 
                      VDCE status will also be changed to "Idle" if all block (layer, OIR 
                          and capture) status are "Idle". ]
*/
...
/***************************************************************************
  ...
  ScaledWidth - The parameter defines the size to calculate the scaling ratio. 
                ...
                are clamped to 0. 
  Scaling     - The parameter defines the behaviour. See <r_vdce_Scale_t>.
...
/***************************************************************************
  Function: R_VDCE_LayerBufSet

  Description:
  This function sets the layers base address.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function doesn't use <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock>.
  This API has same feature as <R_VDCE_LayerBaseSet> except Lock/Unlock.

  User should control not to re-enter the same VDCE unit. 
  And, user should not execute this function while other layer functions and 
  extended layer functions of same VDCE unit are being executed.
...
*/
r_vdce_Error_t R_VDCE_LayerBufSet(const uint32_t Unit,
                                  const uint32_t LayerNr,
                                  const uint32_t Address);
...
/***************************************************************************
  ...
  If color format set by <R_VDCE_LayerFormatSet> has alpha channel
  (i.e. ARGBxxxx, RGBAxxxx, CLUTx ), the alpha channel per pixel data is enabled at first.
  This function can disable this alpha channel.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  CkReplace - The parameter specifies the color signal to replace. Range changes by the format.
              ...
              When a format is CLUT8, CLUT4 or CLUT1, the range of CkReplace. A, R, G, B is
              0 to 255.
...
/***************************************************************************
  ...
  Parameter:
  Unit     - VDCE unit number to capture.
  Buffer1  - Address of the first buffer. When interlace signal is input, capture data of top field
             is written to this address. 
             When progressive signal is input, all capture data is written to this address. 
             Lower 7 bits are clamped to 0. 
  Buffer2  - Address of the second buffer. When interlace signal is input, capture data of bottom
             field is written to this address. 
             When progressive signal is input, this address is not used.
             Lower 7 bits are clamped to 0. 
  ...
  Width    - The parameter specifies the width of the incoming video in pixels.
             Range is 4 to 2008. Lower 2 bits are clamped to 0.
  ...
  Height   - The parameter specifies the Height of the incoming video in pixels.
             For an interlaced video, the height will be the height of one field.
             Range is 4 to 1024. Lower 2 bits are clamped to 0.
             Range of sum of StartY and Height is 2039 and less.
  StartX   - The parameter specifies the x position to capture start in pixels. 
             ...
             If setting value is 0 to 15, this function will round up to 16.
             When DE mode is enabled (see R_VDCE_CAP_MODE_DE_MODE), the reference point is 
             DE signal. StartX pixels are skipped after DE signal. The range of 0 to 2011.
  StartY   - The parameter specifies the y position to capture start in pixels. 
             ...
             If setting value is 0 to 3, this function will round up to 4.
             When DE mode is enabled (see R_VDCE_CAP_MODE_DE_MODE), the reference point is 
             DE signal after Vsync signal. StartY pixels are skipped after 1st DE signal. 
             The range of 0 to 2035.
             When video data is input from MIPI, capturing start from top/left position if
             StartX = 17 and StartY = 0 are set with DE mode. 
  FbFormat - It specifies the frame buffer format. See <r_vdce_Fbformat_t>.
             ...
             Following optional flag can be set with OR operation. 
                - R_VDCE_FB_RB_SWAP  
  ...
  Initialized   - OK
  Idle          - OK
  Executing     - OK (Parameters become effective after the capture status is changed from
                      Idle to Executing.)
...
/***************************************************************************
  ...
  Mode - The following flags of type <r_vdce_CapMode_t> can be combined with '|'.
         ...
         The following flags are optional.
           ...
           -  R_VDCE_CAP_MODE_DE_MODE  
           -  R_VDCE_CAP_MODE_PAL      
           -  R_VDCE_CAP_MODE_EAV      
           -  R_VDCE_CAP_MODE_SYNC_ONLY
  ...
  RH850/D1M1A   - OK (Unit=0 is only available.)
  RH850/D1M1-V2 - OK
  RH850/D1M1(H) - OK (DE mode is not suppoted.)
  RH850/D1L2(H) - NG
*/
...
/***************************************************************************
  ...
  Description:
  This function sets the buffer address for the capture.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function doesn't use <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock>.
  User should control not to re-enter the same VDCE unit. 
  And, user should not execute this function while other capture functions 
  of same VDCE unit are being executed.

  Parameter:
  Unit     - VDCE unit number to capture.
  Buffer1  - Address of the first buffer. 
             This parameter is the same as Buffer1 of <R_VDCE_CapBufGeometrySetup>.
  Buffer2  - Address of the second buffer.
...
/***************************************************************************
  ...
  Description:
  This function sets the first buffer address and y position for the capture.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  Description:
  This function sets the second buffer address and y position for the capture.
  This setting is valid until <R_VDCE_DeInit> is executed.
  This API function uses <R_VDCE_Sys_Lock> and <R_VDCE_Sys_Unlock> to prevent multiple execution.
  When executing this API function by the interrupt handler, be careful of <R_VDCE_Sys_Lock> and
  <R_VDCE_Sys_Unlock> having to be able to be executed by the interrupt handler.
...
/***************************************************************************
  ...
  > |  0  |R_VDCE_CAPT_NO_DISPLAY| No connection    |
  > |  1  |R_VDCE_CAPT_NO_DISPLAY| No connection    |
  > +-----+----------------------+------------------+

  If R_VDCE_CAPT_NO_DISPLAY is specified, the capturing starts independently of the layer
  control and displaying. So, layer control like a Scaling-down is not available. And,
  capture option of R_VDCE_CAPT_MD_H_MIRRORING and R_VDCE_CAPT_MD_V_MIRRORING are not 
  available too.

  Parameter:
  Unit       - VDCE unit number to capture.
  OutputUnit - VDCE unit number to display.
               R_VDCE_CAPT_NO_DISPLAY is also selectable when capture is independently
               of displaying.
  ...
  Executable Capture Status:
  Uninitialized - NG
  Initialized   - NG (when OutputUnit is 0 or 1.) / OK (when OutputUnit is R_VDCE_CAPT_NO_DISPLAY.)
...
/***************************************************************************
  Function: R_VDCE_CapViewPortSet

  Description:
  This function sets the capture viewport parameters.
  This function can be changed the capturing start position and size from first setting by 
  <R_VDCE_CapBufGeometrySetup>.
  
  Dynamic changes can cause momentary screen disruptions. 
  To avoid this, change to IDLE state by <R_VDCE_CapDisable> and then call this function.
  ...
  Unit     - VDCE unit number to capture.
  Width    - The parameter specifies the width of the incoming video in pixels.
             Same as Width  of <R_VDCE_CapBufGeometrySetup>.
  Height   - The parameter specifies the height of the incoming video in pixels.
             Same as Height of <R_VDCE_CapBufGeometrySetup>.
  StartX   - The parameter specifies the x position to capture start in pixels. 
             Same as StartX of <R_VDCE_CapBufGeometrySetup>.
  StartY   - The parameter specifies the y position to capture start in pixels. 
             Same as StartY of <R_VDCE_CapBufGeometrySetup>.
  ...
  RH850/D1L2(H) - NG 
*/
r_vdce_Error_t R_VDCE_CapViewPortSet(const uint32_t          Unit,
                                     const uint32_t          Width,
                                     const uint32_t          Height,
                                     const uint32_t          StartX,
                                     const uint32_t          StartY);
...
/***************************************************************************
  Function: R_VDCE_CapRateSet

  Description:
  This function sets the writing rate of buffer for the capture.
  If this function is not called, all captured data is written to capture buffer.
  ...
  Parameter:
  Unit     - VDCE unit number to capture.
  Rate     - Writing rate. See <r_vdce_CapRate_t>.
  Field    - Writing field select. See <r_vdce_CapField_t>.
  ...
  RH850/D1L2(H) - NG 
*/
r_vdce_Error_t R_VDCE_CapRateSet(const uint32_t          Unit,
                                 const r_vdce_CapRate_t  Rate,
                                 const r_vdce_CapField_t Field);

/***************************************************************************
  Function: R_VDCE_CapExtVsyncSet
  ...
  If HsyncCycle is set as 0 or this function is not called, the default value is selected 
  automatically.
  NTSC or PAL is selected by R_VDCE_CAP_MODE_PAL flag with <R_VDCE_CapModeSet>.
  
  Vsync protection is effective when external Vsync input is selected.
  Vsync protection timing is made by PixelClock set by <R_VDCE_DisplayTimingSet>.
  ...
  R_VDCE_INTC_NO_VI_VSYNC_SIGNAL_1 interrupt occurs.
  Vsync protections are disabled by default. 
  <R_VDCE_DisplayVsyncProtectionSet> provides the same feature, but with lower accurate.
  This function setting takses precedence over <R_VDCE_DisplayVsyncProtectionSet>.
  ...
  Parameter:
  Unit        - VDCE unit number to capture.
  HsyncCycle  - Horizontal cycle of input signal. The range is 4 to 2046.
                If 0 is set, VDCE driver set automatically.
...
r_vdce_Error_t R_VDCE_CapExtVsyncSet(const uint32_t          Unit,
