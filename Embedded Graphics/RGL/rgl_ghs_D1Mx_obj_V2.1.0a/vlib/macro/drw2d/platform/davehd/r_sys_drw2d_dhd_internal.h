...
FILE    : $Id: r_sys_drw2d_dhd_internal.h 17241 2020-11-05 10:50:50Z shinya.tomari.wj@renesas.com $
============================================================================
DESCRIPTION
...
/***********************************************************
  ...
  Returns:
    Edge control code.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge0(dhd_uint32_t X);/* PRQA S 1055 */
...
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge1(dhd_uint32_t X);/* PRQA S 1055 */
...
/***********************************************************
  ...
  Returns:
    Edge control code.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge2(dhd_uint32_t X);/* PRQA S 1055 */
...
/***********************************************************
  ...
  Returns:
    Edge control code.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge3(dhd_uint32_t X);/* PRQA S 1055 */
...
/***********************************************************
  ...
  Returns:
    Edge control code.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge4(dhd_uint32_t X);/* PRQA S 1055 */
...
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_uv(dhd_uint32_t X);/* PRQA S 1055 */
...
/***********************************************************
  ...
  Returns:
    Updated attribute flags.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_rhw(dhd_uint32_t X);/* PRQA S 1055 */
...
/***********************************************************
  ...
  Returns:
    Updated attribute flags.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_col(dhd_uint32_t X);/* PRQA S 1055 */
...
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge0(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
    return DHD_EDGE0(X);
}
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge1(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
    return DHD_EDGE1(X);
}
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge2(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
    return DHD_EDGE2(X);
}
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge3(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
    return DHD_EDGE3(X);
}
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Edge4(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
    return DHD_EDGE4(X);
}
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_uv(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_rhw(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
...
/***********************************************************
  ...
  For details see function declaration.
*/
R_INLINE dhd_uint32_t R_DRW2D_Sys_DHD_Draw_col(dhd_uint32_t X)/* PRQA S 1055,3240 */
{
...
r_drw2d_Error_t R_DRW2D_Sys_DHD_PixelFormatToDHDTexelOrg (r_drw2d_PixelFormat_t PixelFormat, dhd_texel_org_t *DstDhdTexelOrg);/* PRQA S 0777 */
...
/***********************************************************
  ...
  Return value:
    R_FALSE if DstBlendFact is R_NULL or SrcBlendFactor is not supported, else R_TRUE.
*/
