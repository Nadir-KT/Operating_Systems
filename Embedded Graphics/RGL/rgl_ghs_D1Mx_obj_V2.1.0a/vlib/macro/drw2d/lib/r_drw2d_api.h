...
FILE    : $Id: r_drw2d_api.h 17243 2020-11-05 11:04:26Z shinya.tomari.wj@renesas.com $
============================================================================
DESCRIPTION
Driver for DRW2D
============================================================================
...
/*******************************************************************************
  ...
  An application using DRW2D API with D/AVE HD should include the following header files.
...
typedef enum
{
    __R_DRW2D_FRAMEBUFFERFLAGS_PLACEHOLDER__  /* PRQA S 0602 */
...
} r_drw2d_ConvolutionKernelPreset2d_t;     /* PRQA S 0779 */
...
/*******************************************************************************
  ...
  Restriction: 
  If <R_DRW2D_CONVMODE_BLEEDING> is selcted, the convolution filter will output incorrect pixels 
  infrequently.
...
/*******************************************************************************
  ...
  by <R_DRW2D_GpuFinished> are one to one relationship. If it doesnÅft confirm completion for 
...
*/
R_INLINE r_drw2d_FixedP_t R_DRW2D_FixMul(r_drw2d_FixedP_t A, r_drw2d_FixedP_t B);   /* PRQA S 1055 */

R_INLINE r_drw2d_FixedP_t R_DRW2D_FixMul(r_drw2d_FixedP_t A, r_drw2d_FixedP_t B)   /* PRQA S 1055, 3240 */
{
    union { uint32_t lh[2]; int64_t ll;} c;
    c.ll = A;
    c.ll *= B;
    return (c.lh[0] >> 16u) | (c.lh[1] << 16u);   /* PRQA S 4446 */
}
...
*/
R_INLINE r_drw2d_FixedP_t R_DRW2D_FixDiv(r_drw2d_FixedP_t A, r_drw2d_FixedP_t B);   /* PRQA S 1055 */

R_INLINE r_drw2d_FixedP_t R_DRW2D_FixDiv(r_drw2d_FixedP_t A, r_drw2d_FixedP_t B)   /* PRQA S 1055, 3240 */
{
#if defined(__ghs__)
#pragma ghs startnomisra
#endif
    int64_t a64 = A;
    return (r_drw2d_FixedP_t) ((a64 << 16u) / B);   /* PRQA S 4533 */
#if defined(__ghs__)
#pragma ghs endnomisra
#endif
}
...
*/
R_INLINE r_drw2d_FixedP_t R_DRW2D_FixAbs(r_drw2d_FixedP_t A);   /* PRQA S 1055 */

R_INLINE r_drw2d_FixedP_t R_DRW2D_FixAbs(r_drw2d_FixedP_t A)   /* PRQA S 1055, 3240 */
{
    uint32_t result;
...
/*******************************************************************************
  ...
  Calculate tangens function for Angle
