...
FILE    : $Id: r_drw2d_priv.h 17240 2020-11-05 09:44:49Z shinya.tomari.wj@renesas.com $
============================================================================
DESCRIPTION
Driver for DRW2D
============================================================================
...
*/
R_INLINE void drw2d_CheckUpdateEffectiveClipRect (r_drw2d_DeviceBase_t *DeviceBase);   /* PRQA S 1055 */

R_INLINE void drw2d_CheckUpdateEffectiveClipRect (r_drw2d_DeviceBase_t *DeviceBase) {   /* PRQA S 1055, 3240 */
   if(0u != (DeviceBase->State.APIDirtyFlags & R_DRW2D_API_DIRTY_EFFCLIPRECT))
   {
