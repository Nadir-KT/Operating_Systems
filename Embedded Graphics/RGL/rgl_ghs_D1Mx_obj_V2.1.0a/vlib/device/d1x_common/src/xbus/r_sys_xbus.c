...
FILE    : $Id: r_sys_xbus.c 15516 2018-01-26 09:21:43Z matthias.nippert $
============================================================================ 
DESCRIPTION
...
uint32_t R_XBUS_SYS_GetMaxIdx(uint32_t Unit) 
{
    ...
    uint32_t        ret_val = 0; 
    if ( (device < R_DEV_R7F701402) || (device == R_DEV_R7F701416) || (device == R_DEV_R7F701417) )
    {
        ret_val = 0; 
    }
    else if ( (device < R_DEV_R7F701408) || (device == R_DEV_R7F701418) || (device == R_DEV_R7F701441) || (device == R_DEV_R7F701442))
    {
        ret_val = 128u; 
    }
