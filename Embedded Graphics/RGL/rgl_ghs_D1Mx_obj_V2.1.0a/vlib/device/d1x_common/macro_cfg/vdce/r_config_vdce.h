...
#define R_VDCE_Write32(ADDR, VALUE)  {R_DBG_PrintRegCmd(32, (ADDR), (VALUE)); \
...
*/
#ifdef R_DBG_PRINT_VDCE_REGS
#define R_VDCE_Write16(ADDR, VALUE)  {R_DBG_PrintRegCmd(16, (ADDR), (VALUE)); \
...
/***********************************************************
  Constant: R_VDCE_STATIC
  
  Definition for reserved word "static".
*/

#ifndef R_VDCE_BUILD_UNIT_TEST
  #define R_VDCE_STATIC static
#else
  #define R_VDCE_STATIC
#endif
