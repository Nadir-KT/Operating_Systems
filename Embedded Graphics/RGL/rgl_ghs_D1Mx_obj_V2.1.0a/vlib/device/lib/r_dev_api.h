...
{\
  ...
  do\
  {\
    *((volatile uint32_t*)(PROT_ADDR)) = (0x000000a5u);\
  ...
  } while ((new_val != (VALUE)) &&  (prot_stat != 0u));\
...
typedef enum
{
    ...
    R_DEV_SYSCALL_SUPERVISOR_MODE = 0,
...
/***********************************************************
  Function: R_DEV_SysInit

  Initialize global variables in Porting layer.
